 ...
 */
let users = [
  { name: "Isfa", age: 20, major: "Informatics" },
  { name: "Nurul", age: 27, major: "Mathematics" },
  { name: "Raihan", age: 19, major: "English" },
  { name: "Oka", age: 22, major: "Analyst" },
  { name: "Ahmad", age: 21, major: "Biology" }
];
